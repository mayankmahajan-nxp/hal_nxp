...
if(${MCUX_DEVICE} MATCHES "KW45")
  list(APPEND CMAKE_MODULE_PATH
      ...
      ${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/components/power_manager/boards/KW45B41Z-EVK
  ...
  if(CONFIG_BT)
    ...
    zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/framework/FunctionLib)
    zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/framework/HWParameter)
    zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/framework/RNG)
    zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/framework/platform/kw45_k32w1/configs)
    zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/ble_controller/interface)
    zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/mcmgr/src)
    zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/rpmsg_lite/lib/include)
    zephyr_include_directories(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/rpmsg_lite/lib/include/platform/kw45b41)

    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/framework/platform/kw45_k32w1/fwk_platform_ble.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/mcmgr/src/mcmgr_internal_core_api_kw45b41_ext.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/mcmgr/src/mcmgr_internal_core_api_kw45b41.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/mcmgr/src/mcmgr.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/framework/platform/kw45_k32w1/fwk_platform.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/framework/FunctionLib/FunctionLib.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/framework/platform/kw45_k32w1/fwk_platform_ics.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/rpmsg_lite/lib/common/llist.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/rpmsg_lite/lib/virtio/virtqueue.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/rpmsg_lite/lib/rpmsg_lite/porting/platform/kw45b41/rpmsg_platform_ext.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/rpmsg_lite/lib/rpmsg_lite/porting/environment/rpmsg_env_bm.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/rpmsg_lite/lib/rpmsg_lite/porting/platform/kw45b41/rpmsg_platform.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/mcmgr/src/mcmgr_imu_internal.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/multicore/rpmsg_lite/lib/rpmsg_lite/rpmsg_lite.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/framework/HWParameter/HWParameter.c)
    zephyr_library_sources(${CMAKE_CURRENT_LIST_DIR}/mcux-sdk/middleware/wireless/ble_controller/src/controller_api.c)
